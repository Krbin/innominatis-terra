...
image: "[[]]"
name: Zachareus, Reality Transcendent
size: Medium
type: humanoid
subtype:
...
skillsaves:
  - perception: 21
senses: "truesight 1200 ft., passive Perception 26"
languages: "Common, Draconic, Elvish, Giant, Celestial, Abyssal, Infernal"
damage_resistances: "cold, fire, lightning, thunder, force"
damage_immunities: "poison, acid, necrotic, bludgeoning, piercing, and slashing from nonmagical attacks"
condition_immunities: "charmed, frightened, grappled, paralyzed, petrified, poisoned, prone, restrained"
cr: ??
traits:
  - name: "Reality Transcendent"
    desc: "Being that has transcendended the material constrains of creation is no longer affected by its whims. It gains immunity to most non-magical attacks."
  - name: "Fate Exchange (3/Day)"
    desc: "If the Reality Transcendent fails a saving throw, it can choose to exchange fate with one creature in its line of sight. The chosen creature is affected by the condition that the Reality Transcendent faild save against and the Reality Transcendent can choose one effect that affected the creature gained in the last 3 rounds of combat gaining it for itself which the chosen creature loses."
actions:
  - name: Multiattack
